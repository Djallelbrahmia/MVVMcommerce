...
class _$RegisterObjectImpl implements _RegisterObject {
  _$RegisterObjectImpl(this.countryCode, this.name, this.email, this.username,
  ...
  @override
  String toString() {
    return 'RegisterObject(countryCode: $countryCode, name: $name, email: $email, username: $username, password: $password, mobileNumber: $mobileNumber, profilPicture: $profilPicture)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, countryCode, name, email,
      username, password, mobileNumber, profilPicture);
...
abstract class _RegisterObject implements RegisterObject {
  factory _RegisterObject(
      ...
      final String password,
      final String mobileNumber,
      final String profilPicture) = _$RegisterObjectImpl;
